...
void EKF_SOC_OPT(double I, double V, double T, double Nc, double X[2][1], double *Vt, double *Vt_Error, double P[2][2], double Q[2][2], double R, double KG[2][1], double prevI, double t);
